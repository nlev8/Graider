...
1. `backend/automation/runner.js` — the core engine
2. `backend/routes/automation_routes.py` — Flask CRUD + subprocess routes
3. `backend/routes/__init__.py` — register blueprint
4. `frontend/src/services/api.js` — add API functions
5. `frontend/src/components/AutomationBuilder.jsx` — full component
6. `frontend/src/App.jsx` — add tab + import
7. `backend/automation/picker.js` — element picker
8. `backend/services/assistant_tools_automation.py` — AI tools
9. `backend/services/assistant_tools.py` — register submodule
10. `backend/automation/templates/*.json` — pre-built templates

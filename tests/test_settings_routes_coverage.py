...
class TestSaveRubric:
    ...
    @patch('backend.routes.settings_routes.storage_save')
...
class TestLoadRubric:
    ...
    @patch('backend.routes.settings_routes.storage_load')
...
class TestListRosters:
    ...
    @patch('backend.routes.settings_routes.os.listdir')
...
class TestDeleteRoster:
    ...
    @patch('backend.routes.settings_routes.os.path.exists', return_value=False)
    ...
    @patch('backend.routes.settings_routes.os.remove')
    @patch('backend.routes.settings_routes.os.path.exists', return_value=True)
...
class TestListPeriods:
    ...
    @patch('backend.routes.settings_routes.storage_list_keys')
    @patch('backend.routes.settings_routes.storage_load')
...
class TestListDocuments:
    ...
    @patch('backend.routes.settings_routes.os.listdir', return_value=[])
...
class TestGetParentContacts:
    ...
    @patch('backend.routes.settings_routes.os.path.exists', return_value=False)
    @patch('backend.routes.settings_routes.storage_load', return_value=None)
...
class TestAccommodationPresets:
    ...
    @patch('backend.routes.settings_routes.load_presets')
    ...
    @patch('backend.routes.settings_routes.save_preset', return_value=True)
    ...
    @patch('backend.routes.settings_routes.save_preset', return_value=False)
    ...
    @patch('backend.routes.settings_routes.delete_preset', return_value=True)
    def test_delete_preset_ok(self, mock_delete, client, teacher_headers):
        resp = client.delete('/api/accommodation-presets/custom1',
                             headers=teacher_headers)
        assert resp.status_code == 200

    @patch('backend.routes.settings_routes.delete_preset', return_value=False)
...
class TestStudentAccommodations:
    ...
    @patch('backend.routes.settings_routes.load_presets', return_value={})
    @patch('backend.routes.settings_routes.load_student_accommodations',
           return_value={})
    ...
    @patch('backend.routes.settings_routes.get_student_accommodation',
    ...
    @patch('backend.routes.settings_routes.get_student_accommodation', return_value=None)
    ...
    @patch('backend.routes.settings_routes.audit_log_accommodation')
    @patch('backend.routes.settings_routes.set_student_accommodation', return_value=True)
    ...
    @patch('backend.routes.settings_routes.set_student_accommodation', return_value=False)
    def test_set_single_failure(self, mock_set, client, teacher_headers):
        resp = client.post('/api/student-accommodations/s1',
                           json={"presets": []}, headers=teacher_headers)
        assert resp.status_code == 500

    @patch('backend.routes.settings_routes.remove_student_accommodation',
           return_value=True)
...
class TestParseStudentName:
    ...
    def test_semicolon_format(self):
        from backend.routes.settings_routes import parse_student_name
...
class TestAllowedFile:
    ...
    def test_allowed_csv(self):
        from backend.routes.settings_routes import allowed_file
...
class TestSyncToCloud:
    ...
    @patch('backend.routes.settings_routes.sync_all_to_cloud')
...
class TestUpdateStudent:
    ...
    def test_invalid_email(self, client, teacher_headers):
        ...
        with patch('backend.routes.settings_routes.os.path.exists', return_value=True):
            resp = client.post('/api/update-student',
                               json={"period_filename": "x.csv",
                                     "student_id": "S1",
                                     "student_email": "bad"},
...
class TestImportAccommodations:
    ...
    @patch('backend.routes.settings_routes.import_accommodations_from_csv')
...
class TestExportAccommodations:
    ...
    @patch('backend.routes.settings_routes.export_student_accommodations')
...
class TestClearAndStats:
    ...
    @patch('backend.routes.settings_routes.clear_all_accommodations', return_value=True)
    ...
    @patch('backend.routes.settings_routes.clear_all_accommodations', return_value=False)
    def test_clear_failure(self, mock_clear, client, teacher_headers):
        resp = client.post('/api/clear-accommodations', headers=teacher_headers)
        assert resp.status_code == 500

    @patch('backend.routes.settings_routes.get_accommodation_stats')
...
class TestImportFromFocus:
    ...
    def test_start_import_already_running(self, mock_write, client,
        ...
        import backend.routes.settings_routes as sr

...
export default function WritingProfilesList({ addToast, setSelectedStudentHistory, setStudentHistoryList, studentHistoryList, studentHistoryLoading }) {
  return studentHistoryList.length > 0 ? (
    <>
      <div
        style={{
          maxHeight: "200px",

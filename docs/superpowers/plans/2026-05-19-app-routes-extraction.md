...
**STATUS: CLOSED 2026-05-19** -> shipped via PR1 #424, PR2 #425, PR3 (this PR). app.py 1935 -> 586 LOC; 16 routes extracted into grading_results_routes / ferpa_routes / roster_routes; only the SPA/factory shell remains.

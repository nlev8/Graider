...
- `Backend Tests` job passes (pytest with `--cov-fail-under=40`; bumped 32→40 in PR #239 to match measured ~41%; target 50% per audit MAJOR #4. Raise this floor as coverage grows.)
